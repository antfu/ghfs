  ...
  shortcuts: [
    {
      ...
      'bg-base': 'bg-white dark:bg-[#0d1117]',
      ...
      'op-fade': 'op65',
      'kbd': 'px-1 py-0.1 rounded border border-base bg-secondary font-mono text-[10px] color-muted mya',
      'badge': 'inline-flex items-center px-1.5 py-0.5 rounded text-xs font-medium',
      'hover-fade': 'op0 group-hover:op100 transition',
      'tab-trigger': 'px-3 py-2 -mb-px flex items-center gap-1.5 text-sm color-muted border-b-2 border-transparent hover:color-active data-[state=active]:color-active data-[state=active]:border-primary-500 dark:data-[state=active]:border-primary-400 transition outline-none focus-visible:ring-2 focus-visible:ring-primary-500/40 rounded-t',
